  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-6">
      ...
      <div className="card p-5 mb-6">
        <h2 className="font-semibold text-white mb-4 text-sm">New category</h2>
      ...
      <div className="card overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            {!cats.length && <tr><td colSpan={4} className="text-center py-8 text-white/40 text-sm">No categories yet</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
